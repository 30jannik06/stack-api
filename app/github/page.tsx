                    ...
                    <div key={r.name} style={s.card}>
                      ...
                      >
                        <div>
                          ...
                          {r.description && (
                            <div style={{ fontSize: 12, ...s.muted, marginTop: 4 }}>
                              {r.description}
                            </div>
                          )}
                        </div>
                      ...
                      {r.language && (
                        <span style={{ ...s.badge, marginTop: 8, display: "inline-block" }}>
                          {r.language}
                        </span>
                      )}
                    </div>
          ...
          {resultTab === "info" && tab === "repo" && (
            <>
              <div style={s.card}>
                ...
                >
                  <div>
                    ...
                    {data.description && (
                      <div style={{ fontSize: 13, ...s.muted, marginTop: 6 }}>
                        {data.description}
                      </div>
                    )}
                  </div>
              ...
              <div style={s.card}>
                ...
                <InfoRow
                  k="Aktualisiert"
                  v={new Date(data.updated_at).toLocaleDateString("de-DE")}
                />
              </div>
            </>
          )}
