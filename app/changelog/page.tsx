...
export default function ChangelogPage() {
    return (
        <main style={{ maxWidth: 700, margin: "0 auto", padding: "2rem 1rem", fontFamily: "monospace", color: "var(--color-text-primary)" }}>
            ...
            {changelog.map((release) => (
                <div key={release.version} style={{ marginBottom: "2.5rem" }}>
                    <div style={{ display: "flex", alignItems: "baseline", gap: 12, marginBottom: 16 }}>
                        ...
                        <span style={{ fontSize: 12, color: "var(--color-text-secondary)" }}>{release.date}</span>
                    </div>
