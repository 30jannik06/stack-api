    ...
    return Response.json(
        {
            ...
            avatar_decoration: user.avatar_decoration_data ? {
                ...
                url: `https://cdn.discordapp.com/avatar-decoration-presets/${user.avatar_decoration_data.asset}.png?size=256&passthrough=true`,
                url_512: `https://cdn.discordapp.com/avatar-decoration-presets/${user.avatar_decoration_data.asset}.png?size=512&passthrough=true`,
            } : null,
            banner: {
