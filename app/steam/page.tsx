            ...
            <>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 6, marginTop: 4 }}>
                      <span
                        style={{
                          ...
                          height: 8,
                          borderRadius: "50%",
                          background: statusColors[data.status] || "#80848e",
                          display: "inline-block",
                        }}
                      />
              ...
              <div style={s.card}>
                ...
                {data.created_at && (
                  <InfoRow
                    k="Dabei seit"
                    v={new Date(data.created_at).toLocaleDateString("de-DE")}
                  />
                )}
                {data.last_online && (
                  <InfoRow
                    k="Zuletzt online"
                    v={new Date(data.last_online).toLocaleString("de-DE")}
                  />
                )}
              </div>
                      ...
                      <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
                        ...
                        <div style={{ flex: 1 }}>
                          ...
                          <div style={{ fontSize: 12, ...s.muted, marginTop: 2 }}>
                            {g.playtime_2weeks_hours}h letzte 2 Wochen · {g.playtime_total_hours}h
                            gesamt
                          </div>
                        </div>
                      </div>
