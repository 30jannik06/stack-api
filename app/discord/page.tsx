      ...
      {tab === "guild" && (
        <div style={s.inputRow}>
          <input
            ...
            onKeyDown={(e) => e.key === "Enter" && loadGuild()}
            style={{ flex: 1 }}
          />
      ...
      {tab === "invite" && (
        <div style={s.inputRow}>
          <input
            ...
            placeholder="discord.gg/... oder Code..."
            onKeyDown={(e) => e.key === "Enter" && loadInvite()}
            style={{ flex: 1 }}
          />
      ...
      {(userData || guildData || inviteData) && (
        <>
          <div style={{ ...s.tabs, marginBottom: 16 }}>
            ...
            {tab === "user" && userData && (
              <button
                style={tabStyle(resultTab === "presence")}
                onClick={() => setResultTab("presence")}
              >
                presence
              </button>
            )}
          ...
          {resultTab === "raw" && (
            <pre style={s.pre}>{JSON.stringify(userData || guildData || inviteData, null, 2)}</pre>
          )}
            ...
            <>
              ...
              <div style={s.card}>
                ...
                <InfoRow
                  k="Avatar 256px"
                  v={
                    <span style={{ color: "var(--color-text-info)", fontSize: 11 }}>
                      {userData.avatar.url}
                    </span>
                  }
                />
                      ...
                      >
                        <span
                          style={{
                            ...
                            height: 12,
                            borderRadius: 3,
                            background: "#" + userData.banner.color.toString(16).padStart(6, "0"),
                            display: "inline-block",
                          }}
                        />
              ...
              {!presenceData ? (
                ...
                <>
                  <div style={s.card}>
                    ...
                    >
                      <span
                        style={{
                          ...
                          height: 10,
                          borderRadius: "50%",
                          background: statusColors[presenceData.discord_status] || "#80848e",
                          display: "inline-block",
                        }}
                      />
                    ...
                    <InfoRow
                      k="Desktop"
                      v={presenceData.active_on_discord_desktop ? "aktiv" : "—"}
                    />
                    ...
                    <div style={s.card}>
                      ...
                      <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
                        ...
                        <div>
                          ...
                          <div style={{ fontSize: 12, ...s.muted }}>
                            {presenceData.spotify.artist}
                          </div>
                          <div style={{ fontSize: 11, color: "var(--color-text-tertiary)" }}>
                            {presenceData.spotify.album}
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  {presenceData.activities?.map((a: any) => (
                    <div key={a.id} style={s.card}>
                      ...
                      {a.details && (
                        <div style={{ fontSize: 12, ...s.muted, marginTop: 4 }}>{a.details}</div>
                      )}
                      {a.state && (
          ...
          {resultTab === "info" && tab === "guild" && guildData && (
            <>
              ...
              <div style={s.card}>
                ...
                <InfoRow
                  k="Vanity URL"
                  v={guildData.vanity_url_code ? `discord.gg/${guildData.vanity_url_code}` : "—"}
                />
                ...
                <InfoRow
                  ...
                  v={
                    inviteData.expires_at
                      ? new Date(inviteData.expires_at).toLocaleString("de-DE")
                      : "Nie"
                  }
                />
                {inviteData.inviter && (
                  <InfoRow k="Erstellt von" v={`@${inviteData.inviter.username}`} />
                )}
              </div>
            </>
          )}
