...
const services = [
    ...
    },
    {
        ...
        href: "/npm",
        endpoints: [
            {path: "/api/npm/:package", desc: "Package info, version, downloads"},
        ],
    },
    {
        name: "twitch",
        href: "/twitch",
        endpoints: [
            {path: "/api/twitch/user/:username", desc: "Profile, live status, stream info"},
        ],
    },
    {
        name: "steam",
        href: "/steam",
        endpoints: [
            {path: "/api/steam/user/:steamid", desc: "Profile, status, recently played"},
        ],
    },
];
...
export default function Home() {
    return (
        <main style={{maxWidth: 640, margin: "0 auto", padding: "2.5rem 1rem", fontFamily: "monospace"}}>
            ...
            {services.map((service) => (
                <div key={service.name} style={{marginBottom: "2rem"}}>
                    <div style={{
                        ...
                        <Link href={service.href} style={{fontSize: 12, color: "#666", textDecoration: "none"}}>
                            Try it →
                        </Link>
                    </div>
        ...
        <span style={{fontSize: 13, color: "#666"}}>
          made by{" "}
            <a href="https://github.com/30jannik06" target="_blank" rel="noreferrer"
